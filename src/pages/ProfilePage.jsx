...
export function ProfilePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-brand-dark dark:text-white">{t('profile', 'Profile')}</h1>
              ...
              {profile.role === 'user' && (
                <>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Aadhar Number</p>
                      <p className="text-brand-dark dark:text-white">{profile.aadhar || 'Not provided'}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
