...
export function Sidebar() {
  ...
  const userLinks = [
    ...
    { to: '/dashboard/report', icon: FilePlus2, label: t('reportIncident', 'Report Incident') },
    { to: '/dashboard/chat', icon: MessageSquare, label: t('aiChat', 'AI Chat') },
    { to: '/dashboard/analytics', icon: BarChart3, label: t('analytics', 'Analytics') },
    { to: '/dashboard/profile', icon: User, label: t('profile', 'Profile') },
  ];

  const moderatorLinks = [
    { to: '/dashboard', icon: Shield, label: t('moderatorHub', 'Moderator Hub') },
    { to: '/dashboard/analytics', icon: BarChart3, label: t('platformAnalytics', 'Platform Analytics') },
    { to: '/dashboard/profile', icon: User, label: t('profile', 'Profile') },
  ];
